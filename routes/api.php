...
Route::prefix('fiscal')
    ...
    ->group(function (): void {
        ...
        // importes, IVA por alicuota, intentos, eventos y payloads. Solo las
        // emisiones que comparten empresa/ambiente/POS/tipo se serializan.
        Route::post('documents', [FiscalDocumentController::class, 'store'])
            ->middleware(SerializeFiscalSequence::class);
        ...
        // primero contra ARCA para evitar duplicar numeros. El retry participa
        // del mismo lock que una emision nueva para cerrar carreras con cajas.
        Route::post('documents/{document}/retry', [FiscalDocumentController::class, 'retry'])
        ...
        // Se serializa con issue/retry de esa secuencia para evitar TOCTOU.
        Route::post('documents/{document}/reconcile', [FiscalDocumentController::class, 'reconcile'])
            ->whereNumber('document')
            ->middleware(SerializeFiscalSequence::class);
