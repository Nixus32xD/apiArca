...
class StoreFiscalDocumentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'origin.type' => ['required_with:origin', 'string', 'in:sale,payment,manual'],
            ...
            'invoice_mode' => ['nullable', 'string', 'in:auto,manual'],
            ...
            'customer.document_type' => ['nullable', 'string', 'in:CUIT,DNI,CONSUMIDOR_FINAL,cuit,dni,consumidor_final'],
            'customer.document_number' => ['nullable', 'string', 'max:30'],
            'customer.iva_condition' => ['nullable', 'string', 'max:80'],
            ...
            'payment.method' => ['nullable', 'string', 'in:cash,efectivo,transfer,transferencia,bank_transfer,debit_card,debito,credit_card,credito,other,otro'],
            ...
            'associated_vouchers.*.Cuit' => ['nullable', 'digits:11'],
            'associated_vouchers.*.date' => ['nullable', 'date'],
            'associated_vouchers.*.CbteFch' => ['nullable'],
